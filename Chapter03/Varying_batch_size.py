...
print('*'*40, ' Model with batch size is 32 ', '*'*40)
...
showLossAndAccuracy(train_losses, train_accuracies, val_losses, val_accuracies, EPOCH, 'batch size is 32')
...
print('*'*40, ' Model with batch size is 1000 ', '*'*40)
train_losses, train_accuracies = [], []
val_losses, val_accuracies = [], []
...
showLossAndAccuracy(train_losses, train_accuracies, val_losses, val_accuracies, EPOCH, 'batch size is 1000')