...
print('*'*40, ' Model with SGD optimizer ', '*'*40)
...
showLossAndAccuracy(train_losses, train_accuracies, val_losses, val_accuracies, EPOCH, 'SGD optimizer')
...
print('*'*40, ' Model with Adam optimizer ', '*'*40)
train_losses, train_accuracies = [], []
val_losses, val_accuracies = [], []
...
showLossAndAccuracy(train_losses, train_accuracies, val_losses, val_accuracies, EPOCH, 'Adam optimizer')