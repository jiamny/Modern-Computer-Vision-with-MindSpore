...
import mindspore.dataset.vision as cvision
import mindspore.dataset.transforms as ctrans
...
class _FashionMNIST:
    ...
    def read_image(self, file_name):
        ...
        return imgs_array.astype(np.uint8)
    ...
    def read_label(self, file_name):
        ...
        return np.array(label).astype(np.int32)
...
if __name__ == '__main__':
    ...
    # 填写数据集的上级目录
    root = r'/media/hhj/localssd/DL_data/fashion_MNIST'
