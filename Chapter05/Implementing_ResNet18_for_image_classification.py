...
# 定义resnet18
net = resnet18(class_num=len(classes))
...
for blk in net.layer2:
    X = blk(X)
    print(blk.__class__.__name__, 'output shape:\t', X.shape)
print(X.shape)

for blk in net.layer3:
    X = blk(X)
    print(blk.__class__.__name__, 'output shape:\t', X.shape)
print(X.shape)

for blk in net.layer4:
    X = blk(X)
    print(blk.__class__.__name__, 'output shape:\t', X.shape)
print(X.shape)

out = net.mean(X, (2, 3))
print('1. output shape:\t', out.shape)
out = net.flatten(out)
print('2. output shape:\t', out.shape)
out = net.end_point(out)
print('3. output shape:\t', out.shape)
# ----------------------------------------------------------------
...
best_ckpt_path = "./BestCheckpoint/resnet-flower-best.ckpt"
