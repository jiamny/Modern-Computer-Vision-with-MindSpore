...
def showResults(train_losses, train_accuracies, val_losses, val_accuracies, EPOCH, tlt):
...
print('*'*40, ' Model with 0 hidden layer ', '*'*40)
...
showResults(train_losses, train_accuracies, val_losses, val_accuracies, EPOCH, '0 hidden layer')
...
print('*'*40, ' Model with 1 hidden layer ', '*'*40)
train_losses, train_accuracies = [], []
val_losses, val_accuracies = [], []
...
showResults(train_losses, train_accuracies, val_losses, val_accuracies, EPOCH, '1 hidden layer')
...
print('*'*40, ' Model with 2 hidden layers ', '*'*40)
train_losses, train_accuracies = [], []
val_losses, val_accuracies = [], []
...
showResults(train_losses, train_accuracies, val_losses, val_accuracies, EPOCH, '2 hidden layers')
